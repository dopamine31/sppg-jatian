...
async function fetchJsonData(tableName) { try { const { data, error } = await supabaseClient.from(tableName).select('*'); if (error) { console.error('Error fetching', tableName, error); return []; } return data || []; } catch (error) { console.error(`Error loading table ${tableName}:`, error); return []; } }
...
// ==========================================
// KAMERA GPS & GOOGLE DRIVE (2K + MULTI-LENSA)
// ==========================================
...
// ==========================================
// REDZONE CHAT ROOM (Supabase Realtime)
// ==========================================
